...
public class HomeController extends Controller {
    ...
    public Result getProfile(Long userId) {
        ...
        data.set("connections", objectMapper.valueToTree(user.connections.stream().map(x -> {
        ...
        data.set("connectionRequestsReceived", objectMapper.valueToTree(user.connectionRequestsReceived.stream().map(x -> {
